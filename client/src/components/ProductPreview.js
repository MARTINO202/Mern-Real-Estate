...
function ProductPreview({ _id, category, name,price,beds,sqmeters,address, pictures }) {
    return (
        <LinkContainer to={`/product/${_id}`} style={{ cursor: "pointer", width: "20rem", margin: "10px", }}>
            <div style={{}}>
            <Card style={{ width: "20rem", margin: "10px",marginBottom:"1px solid black",alignItems:"center"}}>
            <Card.Body>
