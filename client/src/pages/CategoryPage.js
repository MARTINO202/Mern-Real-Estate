...
function CategoryPage() {
    ...
    function ProductSearch({ _id, category,price,address,sqmeters,beds, name, pictures }) {
        return <ProductPreview _id={_id} category={category} name={name} pictures={pictures} price={price} address={address} sqmeters={sqmeters} beds={beds} />;
    }
